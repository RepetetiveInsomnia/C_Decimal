...
START_TEST(s21_is_greater_1) {
  s21_decimal value_1 = {.bits = {123457u, 654u, 0xFFFFFFFF, 0}};
  s21_decimal value_2 = {.bits = {123456u, 654u, 0xFFFFFFFF, 0}};
...
START_TEST(s21_is_greater_3) {
  s21_decimal value_1 = {.bits = {123456u, 654u, 0xFFFFFFFF, 0}};
  s21_decimal value_2 = {.bits = {123457u, 654u, 0xFFFFFFFF, 0}};
  value_2.sign_bit = 1;
  int return_value = s21_is_greater(value_1, value_2);
  ck_assert_int_eq(return_value, 1);
}
...
START_TEST(s21_is_greater_7) {
  s21_decimal value_1 = {.bits = {234, 0, 0, 0}};
...
START_TEST(s21_is_equal_1) {
  s21_decimal value_1 = {.bits = {123456u, 654u, 0xFFFFFFFF, 80000000}};
  s21_decimal value_2 = {.bits = {123456u, 654u, 0xFFFFFFFF, 80000000}};
...
START_TEST(s21_is_equal_3) {
  s21_decimal value_1 = {.bits = {0, 0, 0, 0}};
  s21_decimal value_2 = {.bits = {0, 0, 0, 0x80000000}};
  int return_value = s21_is_equal(value_1, value_2);
  ck_assert_int_eq(return_value, 1);
}
END_TEST
...
START_TEST(s21_is_equal_4) {
  s21_decimal value_1 = {.bits = {2, 0, 0, 0}};
  s21_decimal value_2 = {.bits = {20, 0, 0, 0}};
  value_2.exp_bits = 1;
  int return_value = s21_is_equal(value_1, value_2);
  ck_assert_int_eq(return_value, 1);
}
...
START_TEST(s21_is_greater_or_equal_8) {
  ...
  value_1.exp_bits = 4;
  s21_decimal value_2 = {.bits = {12u, 0, 0, 0}};
  value_2.exp_bits = 1;
  int return_value = s21_is_greater_or_equal(value_1, value_2);
  ck_assert_int_eq(return_value, 1);
}
...
START_TEST(s21_is_not_equal_2) {
  s21_decimal value_1 = {.bits = {123453u, 654u, 0xFFFFFFFF, 0}};
  s21_decimal value_2 = {.bits = {123456u, 654u, 0xFFFFFFFF, 0}};
  int return_value = s21_is_not_equal(value_1, value_2);
  ck_assert_int_eq(return_value, 1);
}
...
START_TEST(s21_is_not_equal_3) {
  s21_decimal value_1 = {.bits = {0, 0, 0, 80000000}};
  s21_decimal value_2 = {.bits = {0, 0, 0, 0}};
  int return_value = s21_is_not_equal(value_1, value_2);
  ck_assert_int_eq(return_value, 0);
}
...
START_TEST(s21_add_1) {
  s21_decimal value_1 = {.bits = {13, 0, 0, 0}};
  value_1.exp_bits = 1;
  s21_decimal value_2 = {.bits = {286, 0, 0, 0}};
  value_2.exp_bits = 2;
  s21_decimal result;
  s21_decimal check = {.bits = {416, 0, 0, 0}};
  check.exp_bits = 2;
...
START_TEST(s21_add_2) {
  ...
  s21_decimal check = {.bits = {0, 0, 0, 0}};
  int return_value = s21_add(value_1, value_2, &result);
  ck_assert_int_eq(s21_is_equal(result, check), 1);
  ck_assert_int_eq(return_value, 0);
}
...
START_TEST(s21_add_3) {
  s21_decimal value_1 = {.bits = {0xFFFFFFFF, 0xFFFFFFFF, 0, 0}};
  value_1.exp_bits = 1;
  s21_decimal value_2 = {.bits = {2, 0, 0, 0}};
  value_2.exp_bits = 1;
  s21_decimal result;
  s21_decimal check = {.bits = {0x1, 0x0, 0x1, 0}};
  check.exp_bits = 1;
  int return_value = s21_add(value_1, value_2, &result);
  ck_assert_int_eq(s21_is_equal(result, check), 1);
  ck_assert_int_eq(return_value, 0);
...
START_TEST(s21_add_4) {
  ...
  value_2.exp_bits = 1;
  s21_decimal result;
  s21_decimal check = {.bits = {2873, 0, 0, 0}};
  check.exp_bits = 2;
  int return_value = s21_add(value_1, value_2, &result);
  ck_assert_int_eq(s21_is_equal(result, check), 1);
  ck_assert_int_eq(return_value, 0);
...
START_TEST(s21_add_5) {
  ...
  value_2.exp_bits = 1;
  s21_decimal result;
  s21_decimal check = {.bits = {0x9999999a, 0x99999999, 0x19999999, 0}};
  int return_value = s21_add(value_1, value_2, &result);
  ck_assert_int_eq(s21_is_equal(result, check), 1);
  ck_assert_int_eq(return_value, 0);
}
...
START_TEST(s21_add_8) {
  ...
  value_2.exp_bits = 1;
  s21_decimal result;
  s21_decimal check = {.bits = {2847, 0, 0, 0}};
  check.exp_bits = 2;
  int return_value = s21_add(value_1, value_2, &result);
  ck_assert_int_eq(s21_is_equal(result, check), 1);
  ck_assert_int_eq(return_value, 0);
...
START_TEST(s21_add_10) {
  s21_decimal value_1 = {.bits = {1614, 0, 0, 0}};
  value_1.exp_bits = 3;
  s21_decimal value_2 = {.bits = {46071, 0, 0, 0}};
  value_2.exp_bits = 2;
  s21_decimal result;
  s21_decimal check = {.bits = {462324, 0, 0, 0}};
  check.exp_bits = 3;
  int return_value = s21_add(value_1, value_2, &result);
  ck_assert_int_eq(s21_is_equal(result, check), 1);
  ck_assert_int_eq(return_value, 0);
...
START_TEST(s21_sub_1) {
  ...
  value_2.sign_bit = 1;
  s21_decimal result;
  s21_decimal check = {.bits = {156, 0, 0, 0}};
  check.exp_bits = 2;
...
START_TEST(s21_sub_5) {
  s21_decimal value_1 = {.bits = {64071, 0, 0, 0}};
  value_1.exp_bits = 4;
  s21_decimal value_2 = {.bits = {5919, 0, 0, 0}};
  value_2.exp_bits = 1;
  s21_decimal result;
  s21_decimal check = {.bits = {5854929, 0, 0, 0}};
  check.exp_bits = 4;
  check.sign_bit = 1;
  int return_value = s21_sub(value_1, value_2, &result);
  ck_assert_int_eq(s21_is_equal(result, check), 1);
...
START_TEST(s21_mul_1) {
  ...
  s21_decimal value_2 = {.bits = {7, 0, 0, 0}};
  s21_decimal result = {.bits = {0, 0, 0, 0}};
  s21_decimal check = {.bits = {35, 0, 0, 0}};
...
START_TEST(s21_mul_2) {
  s21_decimal value_1 = {.bits = {0xFFFFFFFF, 0, 0, 0}};
  s21_decimal value_2 = {.bits = {0xFFFFFFFF, 0, 0, 0}};
  s21_decimal result = {.bits = {0, 0, 0, 0}};
  s21_decimal check = {.bits = {1, 0xFFFFFFFE, 0, 0}};
  int return_value = s21_mul(value_1, value_2, &result);
  ck_assert_int_eq(s21_is_equal(result, check), 1);
  ck_assert_int_eq(return_value, 0);
}
...
START_TEST(s21_mul_4) {
  s21_decimal value_1 = {.bits = {123456u, 123u, 0, 0}};
  s21_decimal value_2 = {.bits = {654321u, 654u, 0, 0}};
  value_2.sign_bit = 1;
  value_1.exp_bits = 2;
  value_2.exp_bits = 3;
  s21_decimal result = {.bits = {0, 0, 0, 0}};
  s21_decimal check = {.bits = {0xcedabe40, 0x99c0c5d, 0x13a3a, 0x80050000}};
  int return_value = s21_mul(value_1, value_2, &result);
  ck_assert_int_eq(s21_is_equal(result, check), 1);
  ck_assert_int_eq(return_value, 0);
}
...
START_TEST(s21_mul_6) {
  s21_decimal value_1 = {.bits = {17, 0, 0, 0}};
  value_1.sign_bit = 1;
  s21_decimal value_2 = {.bits = {0, 0, 0, 0}};
  s21_decimal result;
  s21_decimal check = {.bits = {0, 0, 0, 0}};
...
START_TEST(s21_div_2) {
  s21_decimal value_1 = {.bits = {0x88888888, 0x88888888, 0x88888888, 0}};
  s21_decimal value_2 = {.bits = {0x2, 0, 0, 0}};
  value_2.sign_bit = 1;
  s21_decimal result = {.bits = {0, 0, 0, 0}};
  s21_decimal check = {.bits = {0x44444444, 0x44444444, 0x44444444, 0}};
  check.sign_bit = 1;
...
START_TEST(s21_div_3) {
  ...
  value_1.sign_bit = 1;
  s21_decimal value_2 = {.bits = {8, 0, 0, 0}};
  value_2.sign_bit = 1;
  s21_decimal result = {.bits = {0, 0, 0, 0}};
  s21_decimal check = {.bits = {125, 0, 0, 0}};
  check.exp_bits = 2;
  int return_value = s21_div(value_1, value_2, &result);
  ck_assert_int_eq(s21_is_equal(result, check), 1);
  ck_assert_int_eq(return_value, 0);
...
START_TEST(s21_truncate_1) {
  s21_decimal value_1 = {.bits = {35, 0, 0, 0}};
  s21_decimal check = {.bits = {3, 0, 0, 0}};
  value_1.exp_bits = 1;
...
START_TEST(s21_truncate_2) {
  s21_decimal value_1 = {.bits = {123456, 0, 0, 0}};
  value_1.exp_bits = 3;
  value_1.sign_bit = 1;
  s21_decimal check = {.bits = {123, 0, 0, 0}};
  check.sign_bit = 1;
  s21_truncate(value_1, &value_1);
  ck_assert_int_eq(s21_is_equal(value_1, check), 1);
}
...
START_TEST(s21_negate_1) {
  s21_decimal value_1 = {.bits = {5, 0xFFFFFFFF, 0, 0}};
  value_1.sign_bit = 1;
  s21_decimal check = {.bits = {5, 0xFFFFFFFF, 0, 0}};
  s21_decimal result;
...
START_TEST(s21_negate_2) {
  s21_decimal value_1 = {.bits = {1, 1, 1, 0}};
  s21_decimal check = {.bits = {1, 1, 1, 0x80000000}};
  s21_decimal result;
  int return_value = s21_negate(value_1, &result);
  ck_assert_int_eq(s21_is_equal(result, check), 1);
  ck_assert_int_eq(return_value, 0);
...
START_TEST(s21_round_1) {
  s21_decimal value_1 = {.bits = {7464923, 0, 0, 0}};
  value_1.exp_bits = 5;
  s21_decimal check = {.bits = {75, 0, 0, 0}};
  s21_decimal result;
...
START_TEST(s21_round_2) {
  s21_decimal value_1 = {.bits = {7444923, 0, 0, 0}};
  value_1.exp_bits = 5;
  s21_decimal check = {.bits = {74, 0, 0, 0}};
  s21_decimal result;
  int return_value = s21_round(value_1, &result);
  ck_assert_int_eq(s21_is_equal(result, check), 1);
  ck_assert_int_eq(return_value, 0);
...
START_TEST(s21_floor_2) {
  s21_decimal value_1 = {.bits = {7544923, 0, 0, 0}};
  value_1.exp_bits = 5;
  value_1.sign_bit = 1;
  s21_decimal check = {.bits = {76, 0, 0, 0}};
  check.sign_bit = 1;
  s21_decimal result;
  int return_value = s21_floor(value_1, &result);
  ck_assert_int_eq(s21_is_equal(result, check), 1);
...
START_TEST(s21_from_int_to_decimal_1) {
  int src = 49135648;
  s21_decimal check = {.bits = {49135648, 0, 0, 0}};
  s21_decimal result;
...
START_TEST(s21_from_int_to_decimal_4) {
  ...
  ck_assert_int_eq(val.bits[3], 8u << 16);

  s21_from_float_to_decimal(127.1234, &val);
  ck_assert_int_eq(val.bits[0], 1271233978);
  ck_assert_int_eq(val.bits[1], 0);
  ck_assert_int_eq(val.bits[2], 0);
  ck_assert_int_eq(val.bits[3], 7u << 16);
}
END_TEST

START_TEST(s21_from_decimal_to_int_1) {
  s21_decimal value = {.bits = {49135648, 0, 0, 0}};
  value.sign_bit = 1;
  value.exp_bits = 1;
  int dst;
  int check = -4913564;
...
START_TEST(s21_from_decimal_to_int_3) {
  s21_decimal value = {.bits = {2, 3, 0, 0}};
  int dst;
  int check = 0;
  int return_value = s21_from_decimal_to_int(value, &dst);
  ck_assert_int_eq(dst, check);
...
START_TEST(s21_from_float_to_decimal_2) {
  float f = -128.023;
  s21_decimal result;
  s21_decimal check = {.bits = {1280229950, 0, 0, 0}};
  check.exp_bits = 7;
  check.sign_bit = 1;
  int return_value = s21_from_float_to_decimal(f, &result);
  ck_assert_int_eq(s21_is_equal(result, check), 1);
...
START_TEST(s21_from_decimal_to_float_1) {
  s21_decimal value = {.bits = {1812, 0, 0, 0}};
  value.sign_bit = 1;
  float result;
  float check = -1812;
...
START_TEST(s21_from_decimal_to_float_2) {
  s21_decimal value = {.bits = {18122, 0, 0, 0}};
  value.exp_bits = 3;
  value.sign_bit = 1;
  float result;
  float check = -18.122;
...
START_TEST(s21_from_decimal_to_float_3) {
  s21_decimal value = {.bits = {0xFFFFFF, 0, 0, 0}};
  float result;
